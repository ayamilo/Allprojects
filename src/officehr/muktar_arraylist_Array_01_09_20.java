package officehr;
import java.util.*;
public class muktar_arraylist_Array_01_09_20 {
...
ArrayList methods: add, get, size, clear, set, contains, equals, IsEmpty, indexOf, remove, addAll, RemoveAll, sorting
		...
		size(): returns the total number of the objects
		get(int index): gets the objects from the given index, returns object
		clear(): removes all the objects from the list, size of list will be 0
		...
		isEmpty(): checks if the arrayList's size is 0. returns boolean
